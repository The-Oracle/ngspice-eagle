...
static IFparm MIFmPTable[] = {
    IOP("rise_delay", 0, (IF_REAL|IF_VECTOR), "rise delay"),
    IOP("fall_delay", 1, (IF_REAL|IF_VECTOR), "fall delay"),
    IOP("input_load", 2, (IF_REAL|IF_VECTOR), "input load value (F)"),
    IOP("input_delay", 3, (IF_REAL|IF_VECTOR), "input delay"),
    IOP("table_values", 4, IF_STRING, "lookup table values"),
};


static IFparm MIFpTable[] = {
    OP("locdata", 5, IF_STRING, "lookup table"),
};
